...
def create_grid(gdf: gpd.GeoDataFrame, width: Union[int, float], height: Union[int, float]):
    """
...
def spatial_blocks(gdf: gpd.GeoDataFrame, width: Union[int, float], height: Union[int, float], 
                   nfolds: int, method='random', orientation='tb-lr', random_state=None) :       
    """
